...
def bars_hist():
    pathsA = glob.glob("../DataBases/Teste_Colors/FIRE/A/DIRNet_comp/*.png")
    pathsP = glob.glob("../DataBases/Teste_Colors/FIRE/P/DIRNet_comp/*.png")
    pathsS = glob.glob("../DataBases/Teste_Colors/FIRE/S/DIRNet_comp/*.png")
    ...
    salve_hist_data(hist, "Dirnet.csv")
